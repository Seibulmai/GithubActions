[![Run App ElijahGueret](https://github.com/Seibulmai/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/Seibulmai/GithubActions/actions/workflows/run-app.yaml)
